...
# Carica i dati con un limite sul numero di righe
N = 100000  # Numero di righe da caricare
...
# Nota: Le seguenti righe sono commenti informativi dal codice originale
...
# a parità di tensione deve aumentare la corrente

# se la corrente è troppo bassa, la macchina non sta funzionando correttamente
# PSU i out devono essere tutti e 3 gli alimentatori vicino, se c'è di differenza di 20pti, c'è un problema