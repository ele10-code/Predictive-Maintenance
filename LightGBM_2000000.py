...
if not os.path.exists('plots_lightgbm_2000000'):
    os.makedirs('plots_lightgbm_2000000')
    print("'plots_lightgbm_2000000' folder created.")
...
for feature in feature_columns:
    ...
    plt.savefig(f'plots_lightgbm_2000000/distribution_{feature}.png')
    plt.close()
...
plt.savefig('plots_lightgbm_2000000/feature_correlation_matrix.png')
plt.close()
...
for name, X_resampled, y_resampled in [("SMOTEENN", X_resampled_smoteenn, y_resampled_smoteenn),
    ...
    plt.savefig(f'plots_lightgbm_2000000/confusion_matrix_LightGBM_{name}.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'plots_lightgbm_2000000/feature_importance_LightGBM_{name}.png')
    plt.close()
    ...
    plt.legend(loc='best')
    plt.savefig(f'plots_lightgbm_2000000/learning_curves_LightGBM_{name}.png')
    plt.close()

print("\nVisualizations have been saved in the 'plots_lightgbm_2000000' folder.")
print("\nModeling completed.")