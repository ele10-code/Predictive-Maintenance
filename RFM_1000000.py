...
# Creazione della cartella 'plots' se non esiste
if not os.path.exists('plots_1000000'):
    os.makedirs('plots_1000000')
    print("Cartella 'plots' creata.")
...
sample_size = min(1000000, len(data))  # Usa un campione più piccolo se necessario
...
if len(X_train) > 1000000:
    X_train_subset, _, y_train_subset, _ = train_test_split(X_train_scaled, y_train, train_size=1000000, stratify=y_train, random_state=42)
...
plt.savefig('plots_1000000/confusion_matrix.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots_1000000/feature_importance.png')
plt.close()
