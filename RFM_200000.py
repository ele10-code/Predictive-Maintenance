...
if not os.path.exists('plots_200000'):
    os.makedirs('plots_200000')
...
sample_size = min(200000, len(data))  # Usa un campione più piccolo se necessario
...
if len(X_train) > 200000:
    X_train_subset, _, y_train_subset, _ = train_test_split(X_train_scaled, y_train, train_size=200000, stratify=y_train, random_state=42)
...
plt.savefig('plots_200000/confusion_matrix.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots_200000/feature_importance.png')
plt.close()
