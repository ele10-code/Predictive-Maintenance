...
if not os.path.exists('plots_RFM_outlier_200000'):
    os.makedirs('plots_RFM_outlier_200000')
    print("'plots_RFM_outlier_200000' folder created.")
...
plt.savefig('plots_RFM_outlier_200000/confusion_matrix.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots_RFM_outlier_200000/feature_importance.png')
plt.close()

print("\nVisualizations have been saved in the 'plots_RFM_outlier_200000' folder.")
print("\nModeling completed.")