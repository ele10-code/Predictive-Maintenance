...
if not os.path.exists('plots_xgboost_1000000'):
    os.makedirs('plots_xgboost_1000000')
    print("'plots_xgboost_1000000' folder created.")
...
for name, X_resampled, y_resampled in [("SMOTEENN", X_resampled_smoteenn, y_resampled_smoteenn),
    ...
    plt.savefig(f'plots_xgboost_1000000/confusion_matrix_XGBoost_{name}.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'plots_xgboost_1000000/feature_importance_XGBoost_{name}.png')
    plt.close()
