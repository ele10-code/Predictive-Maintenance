...
if not os.path.exists('plots_xgboost_optimized_1000000'):
    os.makedirs('plots_xgboost_optimized_1000000')
    print("'plots_xgboost_optimized_1000000' folder created.")
...
for name, X_resampled, y_resampled in [("SMOTEENN", X_resampled_smoteenn, y_resampled_smoteenn),
    ...
    plt.savefig(f'plots_xgboost_optimized_1000000/confusion_matrix_XGBoost_{name}_optimal.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f'plots_xgboost_optimized_1000000/feature_importance_XGBoost_{name}.png')
    plt.close()

    # Clear memory
    del random_search, best_model, y_pred, y_pred_proba, y_pred_optimal

print("\nVisualizations have been saved in the 'plots_xgboost_optimized_1000000' folder.")
print("\nModeling completed.")
