...
# Create 'plots' folder
if not os.path.exists('plots_ensemble_200000'):
    os.makedirs('plots_ensemble_200000')
    print("'plots_ensemble_200000' folder created.")
...
plt.savefig('plots_ensemble_200000/confusion_matrix_ensemble.png')
plt.close()
...
plt.tight_layout()
plt.savefig('plots_ensemble_200000/feature_importance_ensemble.png')
plt.close()

print("\nEnsemble modeling completed. Visualizations saved in 'plots_ensemble_200000' folder.")
