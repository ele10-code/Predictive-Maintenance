...
if not os.path.exists('plots_xgboost_optimized_2000000_output'):
    os.makedirs('plots_xgboost_optimized_2000000_output')
    print("'plots_xgboost_optimized_2000000_output' folder created.")
...
device_ids = ['114', '161', '183']  # Lista dei device ID
...
performance_metrics = {
    ...
    'f1_score': [],
    'roc_auc_score': [],
    'anomaly_classification': []  # Aggiungiamo la colonna per l'anomalia
}
...
for device_id in device_ids:
    for iteration in iterations:
        ...
        print(f"Device {device_id}, Iteration {iteration} - Accuracy: {accuracy:.4f}, F1 Score: {f1:.4f}, AUC-ROC: {roc_auc:.4f}, {anomaly_classification}")
...
for device_id in device_ids:
    ...
    plt.savefig(f'plots_xgboost_optimized_2000000_output/smoothed_performance_chart_device_{device_id}.png')
    plt.show()
